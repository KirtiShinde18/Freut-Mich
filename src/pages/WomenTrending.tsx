...
// images 
import wtrend from "../assets/wtrend1.jpeg";
import img1 from "../assets/wtrend.png";
import img2 from "../assets/wtrend1.png";
import img3 from "../assets/wtrend2.png";
import img4 from "../assets/wtrend3.png";
import wtrend2 from "../assets/wtrend5.jpeg";
    ...
    <div className="max-w-6xl mx-auto w-full ">
      ...
      <div className='flex flex-col md:flex-row gap-6 justify-evenly'>
        ...
        <Link to="https://www.instagram.com/trends_ctrl_a?igsh=MzIybWF1bW9kam82" className="hover-3d mt-12 mx-2 cursor-pointer ">
            ...
            <div className="card w-80  md:w-120 md:p-10 text-black bg-cover bg-center rounded-2xl"
              style={{ backgroundImage: `url(${wtrend})` }}>
      ...
      <div className='flex flex-col md:flex-row  justify-evenly '>
        ...
        <div 
          ...
          style={{ backgroundImage: `url(${wtrend2})` }}
        >
